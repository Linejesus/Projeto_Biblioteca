...
@Component({
  ...
  templateUrl:
    './bibliotecas.disponiveis.component.html',

  styleUrl:
    './bibliotecas.disponiveis.component.scss'
})
export class BibliotecasDisponiveis
implements OnInit {
  ...
  constructor(
    private bibliotecasDisponiveisService:
      BibliotecasDisponiveisService,
  ...
  ngOnInit(): void {
    ...
    const titulo =
      this.route.snapshot.paramMap.get('titulo');

    if(titulo){

      this.carregarBibliotecas(titulo);
